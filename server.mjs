...
function buildListingCopyInstruction({ rawData, extraNotes, listingTones, listingDepth, imageCount }) {
  return [
    ...
    "Pierwszy blok po tytule sekcji Opis na portale musi mieć 2-3 mocne zdania pogrubione w całości. To ma być główny nagłówek/oferta otwierająca.",
    ...
    "Nagłówki głównych bloków też pogrub: **Opis na portale**, **Sugestie tytułów**, **Skrócona wersja na Marketplace**, **Wersja na grupy Facebook**, **Bonus YouTube**.",
    ...
    "Marketplace ma być krótszy niż opis portalowy, ale nadal konkretny, mięsisty i nastawiony na szybki odzew: zwykle 700-1100 znaków.",
