...
function buildListingCopyInstruction({ rawData, extraNotes, listingTones, listingDepth, imageCount }) {
  return [
    ...
    "Pierwszy blok po tytule sekcji Opis na portale musi mieć 3-4 mocne zdania pogrubione w całości i napisane WIELKIMI LITERAMI. To ma być mocny wstęp sprzedażowy do skopiowania na portal.",
